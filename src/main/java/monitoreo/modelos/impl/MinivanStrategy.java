...
public class MinivanStrategy implements ITransporteStrategy {

    private int MaxPuntos=16;
    private double MaxPeso=1050;
    ...
    public void AgregarPuntos(Double[][] puntos){
        if(MaxPuntos-puntosEntregaVariado.length>1){
            ...
            if(peso+puntos[0][2]<MaxPeso){
                System.out.println("Peso excedido para la minivan");
            }else{
                peso+=puntos[0][2];
            }
        }else{
