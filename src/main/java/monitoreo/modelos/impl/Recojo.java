...
public class Recojo extends Punto {
    ...
    public Map<String, String> imprimirXML() {
        ...
        System.out.println("\n[Visitor]-[Recojo] --------------- FORNATO RECOJO XML --------------");
        Map<String, String> cadena = new HashMap<>();
        ...
        xml.append("<recojo>");
        xml.append("<comentario>" + getComentarios() + "</comentario>");
        xml.append("<direccion>" + getDireccion() + "</direccion>");
        xml.append("</recojo>");
        xml.append("</impresion>");
        cadena.put("xml", xml.toString());
        System.out.println("[Visitor]-[Recojo] "+cadena.get("xml"));
        System.out.println("[Visitor]-[Recojo] --------------- FORNATO RECOJO XML --------------");
